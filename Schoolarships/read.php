...
<main class="bg-gray-200 relative sm:w-full md:max-w-md lg:max-w-full mx-auto p-8 md:p-3 -my-8  shadow-2xl">
        <section class="">
            <h3 class="font-bold text-4xl relative ml-96 mt-16">List of all students</h3>
            ...
            <hr>
            <a href="schoolarships.php"><button class="bg-black hover:bg-gray-900 text-white w-1/5 h-10 rounded-lg relative bottom-20 focus:outline-none">Schoolarships</button></a><br>
            <hr>
